...
if (isset($_SESSION['LAST_ACTIVITY']) && (time() - $_SESSION['LAST_ACTIVITY']) > $timeout_duration) {
    session_unset();
    session_destroy();
    echo "<script>alert('Session expired. Please login again.'); location.href='login.php';</script>";
    exit();
}
...
<div class="col-sm-9 col-md-10">
  <div class="row mx-5 text-center">
    ...
    <div class="col-sm-4 mt-5">
      <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
        <div class="card-header">No. of Worker</div>
        <div class="card-body">
          <h4 class="card-title">
            <?php echo $totaltech; ?>
          </h4>
  ...
  <div class="mx-5 mt-5 text-center">
    <!--Table-->
    <p class=" bg-danger text-white p-2">List of Customer's Profile</p>
    <?php
